  ...
  return (
    <>
      ...
      <section className='pageTop flex flex-col gap-5 md:pt-20'>
        ...
        <Link href='/' passHref>
          <div className='p-3 w-full xs:max-w-[200px] xs:mx-0 sm:p-3 font-bold mx-auto bg-blue-700  text-center rounded-md text-white  select-none hover:bg-black dark:hover:bg-slate-600'>
            Take me there!
          </div>
        </Link>
      </section>
